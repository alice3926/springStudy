...
<%@ include file="../../include/inc_header.jsp" %>
	...
	<table border="1" align="center" width="80%">
		...
		<tr>
			<td colspan="2">
				<select name="buy_counter" id="buy_counter">
				...
				<table border="1" width="100%" align="center">
					<tr>
						...
						<td>
							...
							<c:if test="${dto.preSubject != null }">
								<a href="#" onclick="suntaek_proc('mall_view','',${dto.preNo})">${dto.preSubject }</a>
							</c:if>	
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<c:if test="${dto.nxtSubject != null }">
								<a href="#" onclick="suntaek_proc('mall_view','',${dto.nxtNo})">${dto.nxtSubject }</a>
							</c:if>	
						</td>
					</tr>				
				</table>
